...
//Add a delegate Here For the main form
-(void) setValue:(int) value
{
    ...
    if ([self.VolumeDelegate respondsToSelector:@selector(VolumeNo:)])
        //call the delegate
        [self.VolumeDelegate VolumeNo:[NSNumber numberWithInt:value]]; //call the method
